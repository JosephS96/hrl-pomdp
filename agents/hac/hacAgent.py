...
class Agent():
    def __init__(self, FLAGS, env, agent_params, n_layers):
        ...
        self.layers = [Layer(i, FLAGS, env, self.sess, agent_params) for i in range(n_layers)]
    ...
    def train(self, env, episode_num):
        ...
        self.goal_array[self.n_layers - 1] = env.get_next_goal(self.FLAGS.test)
        ...
        goal_status, max_lay_achieved = self.layers[self.n_layers - 1].train(self, env, episode_num=episode_num)
        ...
        return goal_status[self.n_layers - 1]
