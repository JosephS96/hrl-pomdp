...
from networks.dqn import DuelingDQN


class DuelingDQNAgent:
    def __init__(self, env, num_episodes=200, render=False):

        self.identifier = 'dueling-dqn'
        self.env = env
        ...
        self.model = DuelingDQN(input_shape=self.env.observation_space.shape, output_shape=self.env.action_space.n, n_neurons=32)
    ...
    def learn(self):
        ...
        print(print(f'Total Training time: {time.time() - start_training_time}'))
...
if __name__ == "__main__":
    ...
    agent = DuelingDQNAgent(env=env, num_episodes=200, render=False)
